This web app allows users to send anonymous messages and view them in a Google Spreadsheet. The messages are separated into two columns: 'NGL' for 'send me anonymous messages' and 'USER ID' for 'username.
